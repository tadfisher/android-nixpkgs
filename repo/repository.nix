...
[
  {
    ...
    dependencies = [ "patcher;v4" "platform-tools" ];
    sources = {
      "linux" = {
        path = "tools_r25.2.5-linux.zip";
        sha1 = "72df3aa1988c0a9003ccdfd7a13a7b8bd0f47fc1";
      };
      "macosx" = {
        path = "tools_r25.2.5-macosx.zip";
        sha1 = "d2168d963ac5b616e3d3ddaf21511d084baf3659";
      };
      "windows" = {
        path = "tools_r25.2.5-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "android-2.0.1_r01-linux.zip";
        sha1 = "ce2c971dce352aa28af06bda92a070116aa5ae1a";
      };
      "macosx" = {
        path = "android-2.0.1_r01-macosx.zip";
        sha1 = "c3096f80d75a6fc8cb38ef8a18aec920e53d42c0";
      };
      "windows" = {
        path = "android-2.0.1_r01-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "android-2.0_r01-linux.zip";
        sha1 = "be9be6a99ca32875c96ec7f91160ca9fce7e3c7d";
      };
      "macosx" = {
        path = "android-2.0_r01-macosx.zip";
        sha1 = "2a866d0870dbba18e0503cd41e5fae988a21b314";
      };
      "windows" = {
        path = "android-2.0_r01-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "android-1.6_r03-linux.zip";
        sha1 = "483ed088e45bbdf3444baaf9250c8b02e5383cb0";
      };
      "macosx" = {
        path = "android-1.6_r03-macosx.zip";
        sha1 = "bdafad44f5df9f127979bdb21a1fdd87ee3cd625";
      };
      "windows" = {
        path = "android-1.6_r03-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "android-1.5_r04-linux.zip";
        sha1 = "5c134b7df5f4b8bd5b61ba93bdaebada8fa3468c";
      };
      "macosx" = {
        path = "android-1.5_r04-macosx.zip";
        sha1 = "d3a67c2369afa48b6c3c7624de5031c262018d1e";
      };
      "windows" = {
        path = "android-1.5_r04-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "android-1.1_r1-linux.zip";
        sha1 = "c054d25c9b4c6251fa49c2f9c54336998679d3fe";
      };
      "macosx" = {
        path = "android-1.1_r1-macosx.zip";
        sha1 = "e21dbcff45b7356657449ebb3c7e941be2bb5ebe";
      };
      "windows" = {
        path = "android-1.1_r1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-3.1.4508709-darwin-x86_64.zip";
        sha1 = "2b37aa55b81a7e5b8a369febf1ac0bad6c7c5d58";
      };
      "linux-64" = {
        path = "lldb-3.1.4508709-linux-x86_64.zip";
        sha1 = "462711c9ee94fec9ff8be5fa8180afec04d1af6f";
      };
      "windows" = {
        path = "lldb-3.1.4508709-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-3.0.4213617-darwin-x86_64.zip";
        sha1 = "2492651690a215317b86c755cd4d584ec9838677";
      };
      "linux-64" = {
        path = "lldb-3.0.4213617-linux-x86_64.zip";
        sha1 = "61d49b6a58953faa61546d631409af5f60d8d9db";
      };
      "windows" = {
        path = "lldb-3.0.4213617-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-2.3.3614996-darwin-x86_64.zip";
        sha1 = "6b0df112c7b9fa41654497fde2fcce990c831e52";
      };
      "linux-64" = {
        path = "lldb-2.3.3614996-linux-x86_64.zip";
        sha1 = "d7abe655650efe9f6989df31835fa3b3f95c2d13";
      };
      "windows" = {
        path = "lldb-2.3.3614996-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-2.2.3271982-darwin-x86_64.zip";
        sha1 = "62089f4e35775e6cedb82d1fa377fdc1de898005";
      };
      "linux-64" = {
        path = "lldb-2.2.3271982-linux-x86_64.zip";
        sha1 = "413649617d97dd9ef163528f64c0500e1b7c4113";
      };
      "windows" = {
        path = "lldb-2.2.3271982-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-2.1.2852477-darwin-x86_64.zip";
        sha1 = "d1e33880a53f1aa8c7e73534adef83a06f091185";
      };
      "linux-64" = {
        path = "lldb-2.1.2852477-linux-x86_64.zip";
        sha1 = "eb9b96d320210fdfe82495b0597ad43e77f1c240";
      };
      "windows-32" = {
        path = "lldb-2.1.2852477-windows-x86.zip";
        sha1 = "1d9c7d3db1e90587be15c9e79db6bd2881c65387";
      };
      "windows-64" = {
        path = "lldb-2.1.2852477-windows-x86_64.zip";
        sha1 = "1d9c7d3db1e90587be15c9e79db6bd2881c65387";
      };
    };
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "lldb-2.0.2558144-darwin-x86_64.zip";
        sha1 = "d92e2f4c8284413eed4f27986e62b167d947033c";
      };
      "linux-64" = {
        path = "lldb-2.0.2558144-linux-x86_64.zip";
        sha1 = "e7060d9b2ba58b28fd7b1a0ea85a151c8371a326";
      };
      "windows-32" = {
        path = "lldb-2.0.2558144-windows-x86.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28.0.3-linux.zip";
        sha1 = "ea6f2f7103cd9da9ff0bdf6e37fbbba548fa4165";
      };
      "macosx" = {
        path = "build-tools_r28.0.3-macosx.zip";
        sha1 = "f8c333a2991b1ab05a671bc6248b78e00edcd83a";
      };
      "windows" = {
        path = "build-tools_r28.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28.0.2-linux.zip";
        sha1 = "b4492209810a3fd48deaa982f9852fef12433d55";
      };
      "macosx" = {
        path = "build-tools_r28.0.2-macosx.zip";
        sha1 = "c10dd5a7825578622fb362a8a34f76eb3ba0c0a9";
      };
      "windows" = {
        path = "build-tools_r28.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28.0.1-linux.zip";
        sha1 = "ee70dfa1fccb58b37cebc9544830511f36a137a0";
      };
      "macosx" = {
        path = "build-tools_r28.0.1-macosx.zip";
        sha1 = "aeef42ad953f1630dd6f5d71eefdc0b825211462";
      };
      "windows" = {
        path = "build-tools_r28.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28-linux.zip";
        sha1 = "d9f8a754d833ccd334f56fcc6089c5925cd82abb";
      };
      "macosx" = {
        path = "build-tools_r28-macosx.zip";
        sha1 = "72088d32d1d82cc3c2cf7cf6618b6130c0c84ade";
      };
      "windows" = {
        path = "build-tools_r28-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28-rc2-linux.zip";
        sha1 = "efe9c0dde0646a07544c864276390ca6e96b24dc";
      };
      "macosx" = {
        path = "build-tools_r28-rc2-macosx.zip";
        sha1 = "0d0314b353589feb10e528b44c5a685b6658d797";
      };
      "windows" = {
        path = "build-tools_r28-rc2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r28-rc1-linux.zip";
        sha1 = "1601977fae25fd478bcfaa0481ca5ea3c609d840";
      };
      "macosx" = {
        path = "build-tools_r28-rc1-macosx.zip";
        sha1 = "2c77821967a2330b7b227072d0b1c02ef19fe2fc";
      };
      "windows" = {
        path = "build-tools_r28-rc1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r27.0.3-linux.zip";
        sha1 = "d85e7a6320eddffe7eeace3437605079dac938ca";
      };
      "macosx" = {
        path = "build-tools_r27.0.3-macosx.zip";
        sha1 = "61d9fb18790c68d66ff73bf1e7ad56bc1f1eef2d";
      };
      "windows" = {
        path = "build-tools_r27.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r27.0.2-linux.zip";
        sha1 = "b687ddf6be84f11607871138aad32cf857d0b837";
      };
      "macosx" = {
        path = "build-tools_r27.0.2-macosx.zip";
        sha1 = "6d5d9cf2a47877f273f4b742b19e712a051a31be";
      };
      "windows" = {
        path = "build-tools_r27.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r27.0.1-linux.zip";
        sha1 = "7f4eedb1077ef948b848040dcd15de9e8a759f4a";
      };
      "macosx" = {
        path = "build-tools_r27.0.1-macosx.zip";
        sha1 = "1edd07bfdbadd95652d093040e16d858f7489594";
      };
      "windows" = {
        path = "build-tools_r27.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r27-linux.zip";
        sha1 = "28542332ba97cf4a08c3eddfcf5edd70e3cf1260";
      };
      "macosx" = {
        path = "build-tools_r27-macosx.zip";
        sha1 = "fb4e8d7e6b8d29a77090e34024077a80458d5ae1";
      };
      "windows" = {
        path = "build-tools_r27-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26.0.3-linux.zip";
        sha1 = "8a2e6c1bcd845844523a68aa17e5442f0dce328c";
      };
      "macosx" = {
        path = "build-tools_r26.0.3-macosx.zip";
        sha1 = "5bb90ed935d99e5bc90686f43b852e68c5ad40df";
      };
      "windows" = {
        path = "build-tools_r26.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26.0.2-linux.zip";
        sha1 = "5b2b7b66c7bf2151f2af183b5b50a17808850592";
      };
      "macosx" = {
        path = "build-tools_r26.0.2-macosx.zip";
        sha1 = "d9ed7c7f149ce38be5dc08979aea8acec1459ca0";
      };
      "windows" = {
        path = "build-tools_r26.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26.0.1-linux.zip";
        sha1 = "5378c2c78091b414d0eac40a6bd37f2faa31a365";
      };
      "macosx" = {
        path = "build-tools_r26.0.1-macosx.zip";
        sha1 = "cbde59de198916b390777dd0227921bfa2120832";
      };
      "windows" = {
        path = "build-tools_r26.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26-linux.zip";
        sha1 = "1cbe72929876f8a872ab1f1b1040a9f720261f59";
      };
      "macosx" = {
        path = "build-tools_r26-macosx.zip";
        sha1 = "d01a1aeca03747245f1f5936b3cb01759c66d086";
      };
      "windows" = {
        path = "build-tools_r26-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26-rc2-linux.zip";
        sha1 = "629bbd8d2e415bf64871fb0b4c0540fd6d0347a0";
      };
      "macosx" = {
        path = "build-tools_r26-rc2-macosx.zip";
        sha1 = "cb1eb738a1f7003025af267a9b8cc2d259533c70";
      };
      "windows" = {
        path = "build-tools_r26-rc2-windows.zip";
        sha1 = "ddaba77db0557a98f6330fbd579ad0bd12cbb152";
      };
    };
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r26-rc1-linux.zip";
        sha1 = "8cd6388dc96db2d7a49d06159cf990d3bbc78d04";
      };
      "macosx" = {
        path = "build-tools_r26-rc1-macosx.zip";
        sha1 = "5c5a1de7d5f4f000d36ae349229fe0be846d6137";
      };
      "windows" = {
        path = "build-tools_r26-rc1-windows.zip";
        sha1 = "43c2ddad3b67a5c33712ae14331a60673e69be91";
      };
    };
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r25.0.3-linux.zip";
        sha1 = "db95f3a0ae376534d4d69f4cdb6fad20649f3509";
      };
      "macosx" = {
        path = "build-tools_r25.0.3-macosx.zip";
        sha1 = "160d2fefb5ce68e443427fc30a793a703b63e26e";
      };
      "windows" = {
        path = "build-tools_r25.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r25.0.2-linux.zip";
        sha1 = "ff953c0177e317618fda40516f3e9d95fd43c7ae";
      };
      "macosx" = {
        path = "build-tools_r25.0.2-macosx.zip";
        sha1 = "12a5204bb3b6e39437535469fde7ddf42da46b16";
      };
      "windows" = {
        path = "build-tools_r25.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r25.0.1-linux.zip";
        sha1 = "ff063d252ab750d339f5947d06ff782836f22bac";
      };
      "macosx" = {
        path = "build-tools_r25.0.1-macosx.zip";
        sha1 = "7bf7f22d7d48ef20b6ab0e3d7a2912e5c088340f";
      };
      "windows" = {
        path = "build-tools_r25.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r25-linux.zip";
        sha1 = "f2bbda60403e75cabd0f238598c3b4dfca56ea44";
      };
      "macosx" = {
        path = "build-tools_r25-macosx.zip";
        sha1 = "273c5c29a65cbed00e44f3aa470bbd7dce556606";
      };
      "windows" = {
        path = "build-tools_r25-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r24.0.3-linux.zip";
        sha1 = "9e8cc49d66e03fa1a8ecc1ac3e58f1324f5da304";
      };
      "macosx" = {
        path = "build-tools_r24.0.3-macosx.zip";
        sha1 = "a01c15f1b105c34595681075e1895d58b3fff48c";
      };
      "windows" = {
        path = "build-tools_r24.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r24.0.2-linux.zip";
        sha1 = "f199a7a788c3fefbed102eea34d6007737b803cf";
      };
      "macosx" = {
        path = "build-tools_r24.0.2-macosx.zip";
        sha1 = "8bb8fc575477491d5957de743089df412de55cda";
      };
      "windows" = {
        path = "build-tools_r24.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r24.0.1-linux.zip";
        sha1 = "84f18c392919a074fcbb9b1d967984e6b2fef8b4";
      };
      "macosx" = {
        path = "build-tools_r24.0.1-macosx.zip";
        sha1 = "5c6457fcdfa07724fb086d8ff4e8316fc0742848";
      };
      "windows" = {
        path = "build-tools_r24.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r24-linux.zip";
        sha1 = "c6271c4d78a5612ea6c7150688bcd5b7313de8d1";
      };
      "macosx" = {
        path = "build-tools_r24-macosx.zip";
        sha1 = "97fc4ed442f23989cc488d02c1d1de9bdde241de";
      };
      "windows" = {
        path = "build-tools_r24-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r23.0.2-linux.zip";
        sha1 = "8a9f2b37f6fcf7a9fa784dc21aeaeb41bbb9f2c3";
      };
      "macosx" = {
        path = "build-tools_r23.0.2-macosx.zip";
        sha1 = "482c4cbceef8ff58aefd92d8155a38610158fdaf";
      };
      "windows" = {
        path = "build-tools_r23.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r23.0.3-linux.zip";
        sha1 = "368f2600feac7e9b511b82f53d1f2240ae4a91a3";
      };
      "macosx" = {
        path = "build-tools_r23.0.3-macosx.zip";
        sha1 = "fbc98cd303fd15a31d472de6c03bd707829f00b0";
      };
      "windows" = {
        path = "build-tools_r23.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r23.0.1-linux.zip";
        sha1 = "b6ba7c399d5fa487d95289d8832e4ad943aed556";
      };
      "macosx" = {
        path = "build-tools_r23.0.1-macosx.zip";
        sha1 = "d96ec1522721e9a179ae2c591c99f75d31d39718";
      };
      "windows" = {
        path = "build-tools_r23.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r23-linux.zip";
        sha1 = "c1d6209212b01469f80fa804e0c1d39a06bc9060";
      };
      "macosx" = {
        path = "build-tools_r23-macosx.zip";
        sha1 = "90ba6e716f7703a236cd44b2e71c5ff430855a03";
      };
      "windows" = {
        path = "build-tools_r23-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r22.0.1-linux.zip";
        sha1 = "da8b9c5c3ede39298e6cf0283c000c2ee9029646";
      };
      "macosx" = {
        path = "build-tools_r22.0.1-macosx.zip";
        sha1 = "53dad7f608e01d53b17176ba11165acbfccc5bbf";
      };
      "windows" = {
        path = "build-tools_r22.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r22-linux.zip";
        sha1 = "a8a1619dd090e44fac957bce6842e62abf87965b";
      };
      "macosx" = {
        path = "build-tools_r22-macosx.zip";
        sha1 = "af95429b24088d704bc5db9bd606e34ac1b82c0d";
      };
      "windows" = {
        path = "build-tools_r22-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21.1.2-linux.zip";
        sha1 = "5e35259843bf2926113a38368b08458735479658";
      };
      "macosx" = {
        path = "build-tools_r21.1.2-macosx.zip";
        sha1 = "e7c906b4ba0eea93b32ba36c610dbd6b204bff48";
      };
      "windows" = {
        path = "build-tools_r21.1.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21.1.1-linux.zip";
        sha1 = "1c712ee3a1ba5a8b0548f9c32f17d4a0ddfd727d";
      };
      "macosx" = {
        path = "build-tools_r21.1.1-macosx.zip";
        sha1 = "836a146eab0504aa9387a5132e986fe7c7381571";
      };
      "windows" = {
        path = "build-tools_r21.1.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21.1-linux.zip";
        sha1 = "b7455e543784d52a8925f960bc880493ed1478cb";
      };
      "macosx" = {
        path = "build-tools_r21.1-macosx.zip";
        sha1 = "df619356c2359aa5eacdd48699d15b335d9bd246";
      };
      "windows" = {
        path = "build-tools_r21.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21.0.2-linux.zip";
        sha1 = "e1236ab8897b62b57414adcf04c132567b2612a5";
      };
      "macosx" = {
        path = "build-tools_r21.0.2-macosx.zip";
        sha1 = "f17471c154058f3734729ef3cc363399b1cd3de1";
      };
      "windows" = {
        path = "build-tools_r21.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21.0.1-linux.zip";
        sha1 = "e573069eea3e5255e7a65bedeb767f4fd0a5f49a";
      };
      "macosx" = {
        path = "build-tools_r21.0.1-macosx.zip";
        sha1 = "b60c8f9b810c980abafa04896706f3911be1ade7";
      };
      "windows" = {
        path = "build-tools_r21.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r21-linux.zip";
        sha1 = "4933328fdeecbd554a29528f254f4993468e1cf4";
      };
      "macosx" = {
        path = "build-tools_r21-macosx.zip";
        sha1 = "9bef7989b51436bd4e5114d8a0330359f077cbfa";
      };
      "windows" = {
        path = "build-tools_r21-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r20-linux.zip";
        sha1 = "b688905526a5584d1327a662d871a635ff502758";
      };
      "macosx" = {
        path = "build-tools_r20-macosx.zip";
        sha1 = "1240f629411c108a714c4ddd756937c7fab93f83";
      };
      "windows" = {
        path = "build-tools_r20-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r19.1-linux.zip";
        sha1 = "1ff20ac15fa47a75d00346ec12f180d531b3ca89";
      };
      "macosx" = {
        path = "build-tools_r19.1-macosx.zip";
        sha1 = "0d11aae3417de1efb4b9a0e0a7855904a61bcec1";
      };
      "windows" = {
        path = "build-tools_r19.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r19.0.3-linux.zip";
        sha1 = "c2d6055478e9d2d4fba476ee85f99181ddd1160c";
      };
      "macosx" = {
        path = "build-tools_r19.0.3-macosx.zip";
        sha1 = "651cf8754373b2d52e7f6aab2c52eabffe4e9ea4";
      };
      "windows" = {
        path = "build-tools_r19.0.3-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r19.0.2-linux.zip";
        sha1 = "a03a6bdea0091aea32e1b35b90a7294c9f04e3dd";
      };
      "macosx" = {
        path = "build-tools_r19.0.2-macosx.zip";
        sha1 = "145bc43065d45f756d99d87329d899052b9a9288";
      };
      "windows" = {
        path = "build-tools_r19.0.2-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r19.0.1-linux.zip";
        sha1 = "18d2312dc4368858914213087f4e61445aca4517";
      };
      "macosx" = {
        path = "build-tools_r19.0.1-macosx.zip";
        sha1 = "efaf50fb19a3edb8d03efbff76f89a249ad2920b";
      };
      "windows" = {
        path = "build-tools_r19.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r19-linux.zip";
        sha1 = "55c1a6cf632e7d346f0002b275ec41fd3137fd83";
      };
      "macosx" = {
        path = "build-tools_r19-macosx.zip";
        sha1 = "86ec1c12db1bc446b7bcaefc5cc14eb361044e90";
      };
      "windows" = {
        path = "build-tools_r19-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r18.1.1-linux.zip";
        sha1 = "68c9acbfc0cec2d51b19efaed39831a17055d998";
      };
      "macosx" = {
        path = "build-tools_r18.1.1-macosx.zip";
        sha1 = "a9d9d37f6ddf859e57abc78802a77aaa166e48d4";
      };
      "windows" = {
        path = "build-tools_r18.1.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r18.1-linux.zip";
        sha1 = "f314a0599e51397f0886fe888b50dd98f2f050d8";
      };
      "macosx" = {
        path = "build-tools_r18.1-macosx.zip";
        sha1 = "16ddb299b8b43063e5bb3387ec17147c5053dfd8";
      };
      "windows" = {
        path = "build-tools_r18.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r18.0.1-linux.zip";
        sha1 = "f11618492b0d2270c332325d45d752d3656a9640";
      };
      "macosx" = {
        path = "build-tools_r18.0.1-macosx.zip";
        sha1 = "d84f5692fb44d60fc53e5b2507cebf9f24626902";
      };
      "windows" = {
        path = "build-tools_r18.0.1-windows.zip";
  ...
  }
  {
    ...
    sources = {
      "linux" = {
        path = "build-tools_r17-linux.zip";
        sha1 = "2c2872bc3806aabf16a12e3959c2183ddc866e6d";
      };
      "macosx" = {
        path = "build-tools_r17-macosx.zip";
        sha1 = "602ee709be9dbb8f179b1e4075148a57f9419930";
      };
      "windows" = {
        path = "build-tools_r17-windows.zip";
  ...
  }
  {
    ...
    license = "android-sdk-license";
    source = {
      path = "3534162-studio.sdk-patcher.zip.bak";
  ...
  }
  {
    ...
    sources = {
      "macosx-64" = {
        path = "cmake-3.6.4111459-darwin-x86_64.zip";
        sha1 = "c9b02d630079783c6d67cb91488b622cfcd9765c";
      };
      "linux-64" = {
        path = "cmake-3.6.4111459-linux-x86_64.zip";
        sha1 = "71c539b9c33f0943e9ad6251fea0b161c0b70782";
      };
      "windows-64" = {
        path = "cmake-3.6.4111459-windows-x86_64.zip";
  ...
  }
  {
    ...
    sources = {
      ...
      "linux-64" = {
        path = "cmake-3.10.2-linux-x86_64.zip";
        sha1 = "439e8799bf59f724f104bf62784b2985f1bfe561";
      };
      "windows-64" = {
        path = "cmake-3.10.2-windows-x86_64.zip";
  ...
  }
  {
    ...
    license = "android-sdk-license";
    dependencies = [ "patcher;v4" "emulator" "platform-tools" ];
    sources = {
      "macosx" = {
        path = "sdk-tools-darwin-4333796.zip";
        sha1 = "ed85ea7b59bc3483ce0af4c198523ba044e083ad";
      };
      "linux" = {
        path = "sdk-tools-linux-4333796.zip";
        sha1 = "8c7c28554a32318461802c1291d76fccfafde054";
      };
      "windows" = {
        path = "sdk-tools-windows-4333796.zip";
