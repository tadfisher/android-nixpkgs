# Generated by nix-android-repo on 2019-05-28T17:23:21.362.
...
}:
{
  packages = {
    ...
    emulator = mkEmulator {
      ...
      sources = {
        x86_64-darwin = {
          url = "emulator-darwin-5537588.zip";
          sha1 = "e8b1b00e881ada6a7f1160c7628e8f2239bcd84d";
        };
        x86_64-linux = {
          url = "emulator-linux-5537588.zip";
          sha1 = "a3745c8c1d4c0a2a5eb8d483914cc7e279493908";
        };
        x86_64-windows = {
          url = "emulator-windows-5537588.zip";
          sha1 = "25d02a44120b9cbf170c4bae31ab26a95a9298b5";
        };
      };
