...
, mkSystemImage
  ...
  build-tools-29-0-3 = mkBuildTools {
    ...
    sources = {
      linux = {
        url = "build-tools_r29.0.3-linux.zip";
        sha1 = "64efff52165cda5e31848acafa46a05e3f3b4651";
      };
      darwin = {
        url = "build-tools_r29.0.3-macosx.zip";
        sha1 = "76520eb7712fb0bb4c023b55c6f65588ee268289";
      };
      windows = {
        url = "build-tools_r29.0.3-windows.zip";
  ...
  emulator = mkEmulator {
    ...
    sources = {
      x86_64-darwin = {
        url = "emulator-darwin-6152914.zip";
        sha1 = "2081aa796afbced3e12e5bb4ae116b223e7557c8";
      };
      x86_64-linux = {
        url = "emulator-linux-6152914.zip";
        sha1 = "c3944e8018048e3873252f41b72c01013d503df8";
      };
      x86_64-windows = {
        url = "emulator-windows-6152914.zip";
        sha1 = "caf4eb7d8df0c2a015b84d0b97e4851f0cb833ee";
      };
    };
