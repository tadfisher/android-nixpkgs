...
, mkSrcOnly
  ...
  build-tools-31-0-0-rc3 = mkBuildTools {
    id = "build-tools;31.0.0-rc3";
    pname = "build-tools-31-0-0-rc3";
    version = "31-rc3";
    sources = {
      darwin = {
    ...
    xml = ./build-tools-31-0-0-rc3.xml;
  };
  ...
  emulator = mkEmulator {
    ...
    sources = {
      x86_64-darwin = {
        url = "https://dl.google.com/android/repository/emulator-darwin_x64-7306749.zip";
        sha1 = "cf377a1709b91ab6976fa53ea31afbde0d710303";
      };
      x86_64-linux = {
        url = "https://dl.google.com/android/repository/emulator-linux_x64-7306749.zip";
        sha1 = "25664c2ea3cc2fd970fb2120900149a8063b56b7";
      };
      x86_64-windows = {
        url = "https://dl.google.com/android/repository/emulator-windows_x64-7306749.zip";
        sha1 = "93cf9c3ee7cdec9fe318cfe1b6a2908cf09b9e00";
      };
    };
  ...
  system-images-android-S-google-apis-arm64-v8a = mkSrcOnly {
    ...
    sources = {
      all = {
        url = "https://dl.google.com/android/repository/sys-img/google_apis/arm64-v8a-S_r03.zip";
        sha1 = "48e8c481d66822c5552dfb099394945724daa1a2";
      };
    };
    displayName = "Google APIs ARM 64 v8a System Image";
  ...
  system-images-android-S-google-apis-x86-64 = mkSrcOnly {
    ...
    sources = {
      all = {
        url = "https://dl.google.com/android/repository/sys-img/google_apis/x86_64-S_r03.zip";
        sha1 = "4501e019ec5936f4d28dc73939f36ea8e7e6a205";
      };
    };
    displayName = "Google APIs Intel x86 Atom_64 System Image";
