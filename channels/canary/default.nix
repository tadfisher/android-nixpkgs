...
, mkSrcOnly
  ...
  system-images-android-32-android-desktop-arm64-v8a = mkSrcOnly {
    ...
    sources = {
      all = {
        url = "https://dl.google.com/android/repository/sys-img/android-desktop/arm64-v8a-32_r03.zip";
        sha1 = "c12050de2b50cada5cc04e9ee74461c91dbf80df";
      };
    };
  ...
  system-images-android-32-android-desktop-x86-64 = mkSrcOnly {
    ...
    sources = {
      all = {
        url = "https://dl.google.com/android/repository/sys-img/android-desktop/x86_64-32_r03.zip";
        sha1 = "f2de3c6de49f5e9685fc291b13bbaee9cab8b6fe";
      };
    };
