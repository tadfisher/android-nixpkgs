...
, mkSrcOnly
  ...
  cmake-3-18-1 = mkPrebuilt {
    ...
    sources = {
      darwin = {
        url = "https://dl.google.com/android/repository/641221ec500b79c04fc41891effcf28f79d6d467.cmake-3.18.1-darwin.zip";
        sha1 = "8bd60e9bcef0a0c4e5bd2d976f1a2ba9430d34ca";
      };
      linux = {
        url = "https://dl.google.com/android/repository/cmake-3.18.1-linux.zip";
        sha1 = "d892f2829f70e387351830b46c5e72140130f6a2";
      };
      windows = {
        url = "https://dl.google.com/android/repository/f292b2b8eea187947c12dcd0c278bcc28cda251f.cmake-3.18.1-windows.zip";
        sha1 = "9ac75a0391cb270acf568fb534778abd00c12f13";
      };
    };
  ...
  cmdline-tools-3-0-beta01 = mkSrcOnly {
  ...
  cmdline-tools-4-0-alpha02 = mkSrcOnly {
    id = "cmdline-tools;4.0-alpha02";
    pname = "cmdline-tools-4-0-alpha02";
    version = "4-rc2";
    sources = {
      linux = {
        url = "https://dl.google.com/android/repository/commandlinetools-linux-6825553_latest.zip";
        sha1 = "e0cf192aa1f18b165078dea57c9cb60221c38ba9";
      };
      darwin = {
        url = "https://dl.google.com/android/repository/commandlinetools-mac-6825553_latest.zip";
        sha1 = "5eb01149af2d95c0890883c3e29b43793830a3c7";
      };
      windows = {
        url = "https://dl.google.com/android/repository/commandlinetools-win-6825553_latest.zip";
        sha1 = "fe1279ae4b1bb744bcec0593f984d374d0696df7";
      };
    };
    displayName = "Android SDK Command-line Tools";
    path = "cmdline-tools/4.0-alpha02";
    license = {
      id = "android-sdk-preview-license";
      hash = "84831b9409646a918e30573bab4c9c91346d8abd";
    };
    xml = ./cmdline-tools-4-0-alpha02.xml;
  };
  ...
  emulator = mkEmulator {
    ...
    sources = {
      x86_64-darwin = {
        url = "https://dl.google.com/android/repository/emulator-darwin-6837279.zip";
        sha1 = "592e5261dd22d2951abe02f34682a10be963584f";
      };
      x86_64-linux = {
        url = "https://dl.google.com/android/repository/emulator-linux-6837279.zip";
        sha1 = "cfd35f7f0f8f051d2200f0c850a5ee55639b3ab5";
      };
      x86_64-windows = {
        url = "https://dl.google.com/android/repository/emulator-windows-6837279.zip";
        sha1 = "70d0b8ecd842bd7f52caaf9074e810fea1e47413";
      };
    };
